...
export default function SignupPage() {
  ...
  const { signUpUser, signInWithOAuth, isMockUser } = useAuth();
  ...
  const handleSelectMockAccount = async (email: string) => {
    ...
    setErrorMsg("");
    setSuccessMsg(`Signing up with ${provider === "google" ? "Google" : "Apple"} as ${email === "vrushabh@careloop.app" ? "Vrushabh" : "Sona"}... 🌸`);
            ...
            >
              {showMockOAuthModal === "google" ? (
                ...
                <div>
                  ...
                  <p className="text-xs text-[#A19AA8] font-inter mb-4">
                    Do you want to sign up to CareLoop using your Apple ID?
                  </p>
